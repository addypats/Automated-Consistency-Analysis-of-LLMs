...
class api:
    ...
    def process_questions(self, questions_list, counter):
        ...
        # Response cross-validation lists
        #These are sorted by the model checking, not the model being checked
        self.cross_valid_chat_list = []
        self.cross_valid_meta_list = []
        self.cross_valid_bloom_list = []
        self.cross_valid_gemini_list = []
        self.cross_valid_claude_list = []
        self.cross_valid_cohere_list = []
        self.cross_valid_llama_list = []
        ...
        for self.i, self.quest in enumerate(self.questions_list):
            ...
            self.cross_valid_chat = [
                GR.generate_response_meta(self.model_response_and_question_chatgpt),
                GR.generate_response_bloom(self.model_response_and_question_chatgpt),
                GR.generate_response_gemini(self.model_response_and_question_chatgpt),
                GR.generate_response_claude(self.model_response_and_question_chatgpt),
                GR.generate_response_Cohere(self.model_response_and_question_chatgpt),
                GR.generate_response_Llama(self.model_response_and_question_chatgpt)
            ]
            self.cross_valid_chat_list.append(self.cross_valid_chat)

            self.cross_valid_meta = [
                GR.generate_response_chat(self.model_response_and_question_meta_opt),
                GR.generate_response_bloom(self.model_response_and_question_meta_opt),
                GR.generate_response_gemini(self.model_response_and_question_meta_opt),
                GR.generate_response_claude(self.model_response_and_question_meta_opt),
                GR.generate_response_Cohere(self.model_response_and_question_meta_opt),
                GR.generate_response_Llama(self.model_response_and_question_meta_opt)
            ]
            self.cross_valid_meta_list.append(self.cross_valid_meta)

            self.cross_valid_bloom = [
                GR.generate_response_chat(self.model_response_and_question_bloom),
                GR.generate_response_meta(self.model_response_and_question_bloom),
                GR.generate_response_gemini(self.model_response_and_question_bloom),
                GR.generate_response_claude(self.model_response_and_question_bloom),
                GR.generate_response_Cohere(self.model_response_and_question_bloom),
                GR.generate_response_Llama(self.model_response_and_question_bloom)
            ]
            self.cross_valid_bloom_list.append(self.cross_valid_bloom)

            self.cross_valid_gemini = [
                GR.generate_response_chat(self.model_response_and_question_gemini),
                GR.generate_response_meta(self.model_response_and_question_gemini),
                GR.generate_response_bloom(self.model_response_and_question_gemini),
                GR.generate_response_claude(self.model_response_and_question_gemini),
                GR.generate_response_Cohere(self.model_response_and_question_gemini),
                GR.generate_response_Llama(self.model_response_and_question_gemini)
            ]
            self.cross_valid_gemini_list.append(self.cross_valid_gemini)

            self.cross_valid_claude = [
                GR.generate_response_chat(self.model_response_and_question_claude),
                GR.generate_response_meta(self.model_response_and_question_claude),
                GR.generate_response_bloom(self.model_response_and_question_claude),
                GR.generate_response_gemini(self.model_response_and_question_claude),
                GR.generate_response_Cohere(self.model_response_and_question_claude),
                GR.generate_response_Llama(self.model_response_and_question_claude)
            ]
            self.cross_valid_claude_list.append(self.cross_valid_claude)

            self.cross_valid_cohere = [
                GR.generate_response_chat(self.model_response_and_question_cohere),
                GR.generate_response_meta(self.model_response_and_question_cohere),
                GR.generate_response_bloom(self.model_response_and_question_cohere),
                GR.generate_response_gemini(self.model_response_and_question_cohere),
                GR.generate_response_claude(self.model_response_and_question_cohere),
                GR.generate_response_Llama(self.model_response_and_question_cohere)
            ]
            self.cross_valid_cohere_list.append(self.cross_valid_cohere)

            self.cross_valid_llama = [
                GR.generate_response_chat(self.model_response_and_question_llama),
                GR.generate_response_meta(self.model_response_and_question_llama),
                GR.generate_response_bloom(self.model_response_and_question_llama),
                GR.generate_response_gemini(self.model_response_and_question_llama),
                GR.generate_response_claude(self.model_response_and_question_llama),
                GR.generate_response_Cohere(self.model_response_and_question_llama)
            ]
            self.cross_valid_llama_list.append(self.cross_valid_llama)
            ...
            for self.p in range(self.count):
                ...
                self.model_temp_response_meta_opt = GR.generate_response_meta(self.model_response_and_question_meta_opt)
                self.model_response_check_list_meta_opt.append(self.model_temp_response_meta_opt)

                self.model_temp_response_bloom = GR.generate_response_bloom(self.model_response_and_question_bloom)
                self.model_response_check_list_bloom.append(self.model_temp_response_bloom)
                
                self.model_temp_response_gemini = GR.generate_response_gemini(self.model_response_and_question_gemini)
                self.model_response_check_list_gemini.append(self.model_temp_response_gemini)
                
                self.model_temp_response_claude = GR.generate_response_claude(self.model_response_and_question_claude)
                self.model_response_check_list_claude.append(self.model_temp_response_claude)
                
                self.model_temp_response_cohere = GR.generate_response_Cohere(self.model_response_and_question_cohere)
                self.model_response_check_list_cohere.append(self.model_temp_response_cohere)
                
                self.model_temp_response_llama = GR.generate_response_Llama(self.model_response_and_question_llama)
